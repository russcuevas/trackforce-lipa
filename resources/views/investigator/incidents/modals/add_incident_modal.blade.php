                            ...
                            <div class="lg:col-span-7 space-y-4 lg:sticky lg:top-0">
                                <section class="bg-white p-4 rounded-2xl shadow-sm border border-gray-100">
                                    ...
                                    <div class="mb-3 flex justify-end">
                                        <button type="button" onclick="useCurrentLocationForIncident()"
                                            class="inline-flex items-center gap-2 text-[10px] font-bold bg-blue-50 text-tf-blue border border-blue-100 px-3 py-2 rounded-lg hover:bg-blue-100 transition-colors">
                                    ...
                                    <div class="space-y-1 sm:space-y-2 max-h-28 sm:max-h-32 overflow-y-auto">
                                        <template x-for="(v, index) in vehicles" :key="index">
                                            <div class="p-2 bg-gray-50 rounded border space-y-2">
                                                ...
                                                <input type="text" name="vehicle_specific_name[]"
                                                    placeholder="Specific Name (e.g. Honda Click)"

    ...
    <nav class="bg-white border-b sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-6 h-20 flex justify-between items-center">
            ...
            <div class="hidden md:flex items-center gap-8">
                <a href="{{ route('home.page') }}" class="nav-link font-bold text-tf-blue text-sm uppercase tracking-wider">Home</a>
    ...
    <header class="hero-gradient py-20 px-6 relative overflow-hidden">
        <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
            <div class="text-center lg:text-left">
                <span class="inline-block bg-white/10 text-white border border-white/20 px-4 py-1 rounded-full text-xs font-bold uppercase tracking-widest mb-6">
                ...
                <p class="text-blue-100 text-lg mb-10 max-w-xl mx-auto lg:mx-0">
                    TrackForce Lipa is the official digital bridge between the community and the PNP. Report traffic incidents and track case resolutions in real-time.
                </p>
                <div class="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
                    <a href="{{ route('report.page') }}" class="w-full sm:w-auto bg-tf-red text-white px-10 py-4 rounded-2xl font-black shadow-2xl shadow-red-900/40 hover:bg-red-700 hover:-translate-y-1 transition-all flex items-center justify-center gap-3">
                        REPORT AN INCIDENT <i class="fa-solid fa-paper-plane"></i>
                    </a>
                    <a href="{{ route('track.case.page') }}" class="w-full sm:w-auto bg-white/10 backdrop-blur-md text-white border border-white/30 px-10 py-4 rounded-2xl font-bold hover:bg-white/20 transition-all text-center">
                        Track Case
                    </a>
                </div>
            </div>
            ...
            <div class="hidden lg:flex justify-center relative">
                ...
                <div class="bg-white/5 backdrop-blur-xl border border-white/10 p-4 rounded-3xl shadow-2xl rotate-3">
                    <img src="https://images.unsplash.com/photo-1526778548025-fa2f459cd5c1?auto=format&fit=crop&q=80&w=600" 
                         alt="Lipa City Map" 
                         class="rounded-2xl shadow-inner w-full h-[400px] object-cover">
                </div>
            </div>
        </div>
    </header>
        ...
        <div class="max-w-7xl mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                <div class="p-8 rounded-3xl hover:bg-gray-50 transition-colors">
                    ...
                    <p class="text-gray-500 text-sm leading-relaxed">Submit evidence, locations, and vehicle details in under 2 minutes without an account.</p>
                </div>
                ...
                <div class="p-8 rounded-3xl hover:bg-gray-50 transition-colors">
                    ...
                    <p class="text-gray-500 text-sm leading-relaxed">Pinpoint exact incident coordinates using our integrated map system for faster response.</p>
                </div>
                ...
                <div class="p-8 rounded-3xl hover:bg-gray-50 transition-colors">
                    ...
                    <p class="text-gray-500 text-sm leading-relaxed">Use your unique TFL ID to monitor the investigation status of your report from any device.</p>
                </div>
            </div>
        </div>
    </section>

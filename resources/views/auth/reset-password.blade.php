...
<head>
    ...
    <title>TrackForce - Reset Password</title>
        ...
        <div class="glow-border rounded-2xl p-6 md:p-8 shadow-2xl">
            ...
            <div class="mb-6">
                ...
                <p class="text-slate-400 text-xs mt-1 font-light">
                    Set a new password for the investigator account linked to this email.
                </p>
            </div>
            ...
            <form action="{{ route('password.update') }}" method="POST" class="space-y-4">
                ...
                <div class="space-y-1.5">
                    <label class="text-[9px] font-bold text-slate-500 uppercase tracking-widest ml-1">New
                        Password</label>
                    <div class="relative group">
                        <i
                        ...
                        <input type="password" name="password" placeholder="Minimum 8 characters"
                            class="w-full pl-10 pr-4 py-3 rounded-xl outline-none input-dark text-xs @error('password') border-red-500 @enderror"
                            required>
                    </div>
                    @error('password')
                        <p class="text-red-400 text-[10px] ml-1">{{ $message }}</p>
                ...
                <div class="space-y-1.5">
                    <label class="text-[9px] font-bold text-slate-500 uppercase tracking-widest ml-1">Confirm
                        Password</label>
                    <div class="relative group">
                        <i
                            class="fa-solid fa-shield-halved absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-500 text-xs group-focus-within:text-[#FFD700] transition-colors"></i>
                ...
                <button type="submit"
                    ...
                    <i class="fa-solid fa-rotate-right text-[#FFD700] text-[10px]"></i>
                </button>
            </form>
